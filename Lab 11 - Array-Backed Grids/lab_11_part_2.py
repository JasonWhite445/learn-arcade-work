...
class MyGame(arcade.Window):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        print("Total of", cells_selected, "cells are selected.")
        ...
        for row in range(ROW_COUNT):
            ...
            for column in range(COLUMN_COUNT):
               if self.grid[row][column] == 1:
                row_cells += 1
                continuous_count += 1
            print("In row", row, "there are", row_cells, "cells selected.")
        ...
        for column in range(COLUMN_COUNT):
            for row in range(ROW_COUNT):
                if self.grid[row][column] == 1:
                    column_cells += 1
            print("In column", column, "there are", column_cells, "cells selected.")
